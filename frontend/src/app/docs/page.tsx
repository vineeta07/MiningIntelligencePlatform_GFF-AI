...
const documents = [
  ...
  },
  {
    ...
    color: "var(--color-crimson)",
    bg: "rgba(193, 18, 31, 0.08)",
    sections: ["ResNet50 Architecture", "7 Rock Classes", "Test Accuracy: 71.8%", "Grad-CAM Explainability"],
  },
  {
    id: "test-suite",
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: "var(--color-text-muted)" }}>ResNet50 — Rock & Mineral Classification</p>
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { label: "Test Accuracy", value: "71.84%" },
            ].map((item) => (

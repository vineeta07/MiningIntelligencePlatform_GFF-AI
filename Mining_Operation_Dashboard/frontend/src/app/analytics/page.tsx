...
export default function AnalyticsPage() {
  ...
  const filteredRecent = recent.filter(r => 
    r.id.toLowerCase().includes(searchClassifications.toLowerCase()) || 
    r.predicted_class.toLowerCase().includes(searchClassifications.toLowerCase()) || 
    r.mine_name.toLowerCase().includes(searchClassifications.toLowerCase())
  );
    ...
    <main className="w-full max-w-[1440px] mx-auto space-y-10 pb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 stagger-children">
          ...
          <div className="kpi-card">
            ...
            <div className="text-2xl font-bold" style={{ color: "var(--color-olive)" }}>78.2%</div>
          </div>
        </div>
          ...
          <div className="p-6 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="relative">
              ...
              <input 
                ...
                onChange={(e) => setSearchClassifications(e.target.value)}
